...
```bash
curl -O https://raw.githubusercontent.com/jinwyp/jinwyp/one_click_script/master/trojan_v2ray_install.sh && chmod +x trojan_v2ray_install.sh && ./trojan_v2ray_install.sh
...
```bash
wget --no-check-certificate https://raw.githubusercontent.com/jinwyp/jinwyp/one_click_script/master/trojan_v2ray_install.sh && chmod +x trojan_v2ray_install.sh && ./trojan_v2ray_install.sh
